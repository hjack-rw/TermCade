...
is the test that makes that drift loud. If it fails: `python scripts/generate_catalog_fingerprint.py`.
"""
...
def test_catalog_fingerprint_matches_what_the_db_generates(tmp_path):
    ...
    assert regenerated == committed, "catalog_fingerprint.py is stale — run `python scripts/generate_catalog_fingerprint.py`"
