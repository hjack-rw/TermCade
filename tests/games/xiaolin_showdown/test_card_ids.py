...
that makes that drift loud. If it fails: `python generate_card_ids.py`.
"""
...
def test_card_ids_matches_what_the_db_generates(tmp_path):
    ...
    assert regenerated == committed, "card_ids.py is out of date — run `python generate_card_ids.py`"
