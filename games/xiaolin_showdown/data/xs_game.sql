...
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (-8, 'Jack-Bot', 'bot', 'Jack Spicer, evil boy genius, built himself a robotic army to fight his battles for him. Versatile and ALMOST infallible.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (-7, 'Beast Form', 'beast_form', 'Going over to the dark side, Chase became infused with the power of a Heylin Demon. He refuses however to meddle in mere mortal affairs.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (-6, 'Witchcraft', 'witchcraft', 'Wuya''s connection to the Shen Gong Wu runs both ways. She can call the lost Wu back into her hand, three times in a run, and a Wu she spends on its power returns to her hand. But the hunger that finds them is never fed.', 1, NULL, NULL);
...
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (-4, 'Dragon of Earth', 'dragon', 'User has access to basic Earth-based attacks, and moves.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (-3, 'Dragon of Fire', 'dragon', 'User has access to basic Fire-based attacks, and moves.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (-2, 'Dragon of Wind', 'dragon', 'User has access to basic Wind-based attacks, and moves.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (-1, 'Dragon of Water', 'dragon', 'User has access to basic Water-based attacks, and moves.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (0, 'Robotics', 'bot', 'Customary robots created and used by Jack. Building them comes naturally to him.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (1, 'Retrokinesis', 'amend', 'Winds a recent moment back a heartbeat, undoing the user''s last action so a mistake can be taken back and made afresh.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (2, 'Anthropomorphism', 'animate', 'Brings inanimate or dead objects to life - but only while it is active, a life on loan so to speak. Used to create powerful constructs like Mala Mala Jong.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (3, 'Power Augmentation', 'boost', 'Could greatly enhance the powers of other Wu that the user is holding. It combines with it, making it count as one in a duel.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (4, 'Repulsion', 'bounce', 'Allows the user to telekinetically push targeted objects (opposite of the Glove of Jisaku).', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (5, 'Hydrokinesis', 'buff', 'Releases a large flood of water, that can also be frozen into ice.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (6, 'Ying-Yang World Access', 'chi_swap', 'Allows the user to travel into the Yin-Yang World. Can change someone else''s Chi at will.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (7, 'Metallaxis', 'cleanse', 'Transforms an object''s alchemical properties by changing its atoms - turning it to inert metal for example.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (8, 'Astrapokinesis', 'conduct', 'Shoots out thunderbolts. Can be used as a powerful energy source.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (9, 'Thyellokinesis', 'double_element', 'Allows the user to generate or manipulate strong winds and tornados (leting its user to become a walking hurricane), but the sword itself cannot be used for physical attacks as it phases through enemies.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (10, 'Klonogenesis', 'double_training', 'Multiplies the user into as many as nine people, but it also divides up the user''s skills (and mental prower is a skill) among all the clones.', 0, 'Clone of {caster}', NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (11, 'Polymorphia', 'dragon', 'Transforms into any weapon the user requires.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (12, 'Chronokinesis', 'draw', 'Freezes anything it is pointed at in time and place for a short while.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (13, 'Oxyderkia', 'enhanced_vision', 'Alows for different kinds of vision (thermal or even sound).', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (14, 'Attraction', 'fetch', 'Allows the user to attract any object toward themselves, including other Shen Gong Wu.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (15, '? ? ?', 'gamble', '? ? ?', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (16, 'Electrokinesis', 'hack', 'Transforms the user into electricity, meaning they can possess and control technology.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (17, 'Temporary Appendage', 'hand_size', 'Acts like an extendable, strong, and durable third arm. Its moves are somewhat independent from the wearer, but always obey their commands.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (18, 'Furious Charge', 'initiative', 'Bull horn that when blown blasts the user at rapid speeds forward at their target (aka a "DASH-i").', 1, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (19, 'Levitation', 'initiative', 'Allows the user to defy gravity, which enables them to walk vertically on walls and even float minimal above ground.', 1, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (20, 'Camouflage', 'initiative', 'Helps its user blend into their surroundings like a chameleon.', 1, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (21, 'Mégathoskinesis', 'initiative', 'Shrinks targeted objects or people to the size of a grain of rice. The size change is not permanent and requires the user to keep a hold of the Wu.', 1, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (22, 'Tongue Twister', 'initiative', 'Makes the user''s enemies babble nonsense non stop. The effect prevents them of taking coherent actions.', -2, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (23, 'Self-conscious Rope', 'initiative', 'Rope that can fulfill simple orders, behaving like a snake while at it. Apart from that it possess all the abilities of an ordinary rope.', -1, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (24, 'Extendable Tendrils', 'initiative', 'It shoots a stream of hair from the comb''s teeth at the intended target and binds it. However, it requires complete focus from the user as you need to control each hair separately.', -1, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (25, 'Méllissakinesis', 'initiative', 'When opened, unleashes a swarm of insects (e.g. ants, flies, bees) at a desired target.', -1, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (26, 'Metáxikinesis', 'initiative', 'Allows the user to fire strands of spider-like silk. The user himself is immune to its stickiness, but opponents will be rendered immobile for a short while. Can also be used to swing from place to place on the slik string.', -1, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (27, 'Astrapokinesis', 'initiative', 'For as long as the coin is in the air the user moves at the speed of light, and everything else is standing still.', 2, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (28, 'Supersonic Flight', 'initiative', 'Carries its user at supersonic speed.', 2, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (29, 'Invisibility', 'initiative', 'Renders its user unseen.', 2, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (30, 'Reality Cutting', 'initiative', 'Cuts through anything, reality included: a clawed portal opens onto any place the user names, and stays open a short while – long enough that others may follow, until reality mends itself.', 2, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (31, 'Blinding Glare', 'initiative', 'Throws up a glittering sphere of light that nobody can look away from and nobody can see past.', -2, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (32, 'Stupefaction', 'initiative', 'Releases a purple gas that leaves its victims confused and foolish, or drops them into a deep sleep outright.', -2, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (33, 'Efiáltiskinesis', 'initiative', 'Walks into a sleeping mind and gives its worst fear a body. It has no hold on anyone awake.', -2, '{fear}', NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (34, 'Shadowstep', 'initiative', 'Allows the user to jump between shadows or dark places.', 2, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (35, 'Vaporization', 'initiative', 'Lets its user turn into a cloud of dust or even liquid, able to pass through narrow openings. It can also create the type of gas or liquid at will.', 1, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (36, 'Elasticity', 'initiative', 'Allows the user''s body to stretch and twist like rubber, making them extremely flexible.', -1, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (37, 'Arktophylaxia', 'initiative', 'Wraps its user in a polar bear fur suit that withstands extremely cold temperatures, resists physical damage, and gives you survival instinct in the wild - making it ideal for traveling in extreme environments', -2, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (38, 'Avian Flight', 'initiative', 'Grants the user the power to fly like a hawk.', 2, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (39, 'Hyperjump', 'initiative', 'Allows the user to jump incredible heights and distances like a kangaroo.', 1, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (40, 'Myiomorphosis', 'initiative', 'Transforms the user into a tiny fly, also giving them a craving for sugar.', -1, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (41, 'Nyktoskopia', 'initiative', 'Lets its user hang upside down like a bat without nausea, and lets them see well in darkness.', -2, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (42, 'Superhuman Strength', 'innate', 'Allows the user to punch with incredible force, capable of creating shock waves during the impact.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (43, 'Deflection', 'innate', 'Protects the user''s head by deflecting attacks and projectiles towards it.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (44, 'Photographic Memory', 'innate', 'Grants its user an instant memory recall. The memories are stored in bubbles inside the Wu and can be shared across users.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (45, 'Impenetrable Defence', 'innate', 'Can temporarily transform into an armor capable of blocking all sorts of attacks, but its weight increases drastically while active.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (46, 'Umbrakinesis', 'innate', 'Allows for shadow manipulation that can influence a physical target. It can absorb and dissipate shadows at will, allowing the user to create shadow copies when it''s charged up.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (47, 'Mnenokinesis', 'innate', 'Erases memory for a short while, leaving its victim unable to recall what they knew.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (48, 'Euthymia', 'luck', 'Your good spirits turn fortune your way and a lost Wu finds its way back to you.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (49, 'Misfortune', 'misfortune', 'Creates ironic or down-right unlucky situations for all of its user''s opponents.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (50, 'Allomorphia', 'morph', 'Allows the user to change their appearance into anything they choose - including the appearance of other beings.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (51, 'Thermokinesis', 'nullify_boost', 'Shoots out sparks that generate heat and can light fires, the sudden bloom of warmth smothering an opponent''s boost.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (52, 'Reversal', 'nullify_curse', 'Reverses the powers of anything that is binary, including other Shen Gong Wu (e.g. the Two-Ton Tunic becomes as light as a feather).', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (53, 'Intangibility', 'nullify_element', 'Makes the user a ghost, allowing them to pass through solid objects and avoid physical attacks, but it doesn''t protect against non-physical attacks.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (54, 'Containment', 'nullify_stats', 'Traps the target in an impervious transparent sphere. It also copies authority and possessions from the prisoner to the user.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (55, 'Subjugation', 'nullify_wu', 'Allows the user to control or disable all other Shen Gong Wu, including multiple Wu constructs like Mala Mala Jong.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (56, 'Telepatheia', 'prognosis', 'Allows the user to hear the thoughts of other people whom the shell is aimed at.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (57, 'Diaskopia', 'read_deck', 'Allows the user to see through solid objects. The user may enhance the ability further by using its sister Shen Gong Wu, the Eagle Scope.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (58, 'Palingenesis', 'refresh', 'Heals any injury. Also regenerates aging over time.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (59, 'Lunarkinesis', 'reverse_element', 'Allows the user to control the sun, the stars and the moon, including their different phases.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (60, 'Teleskopia', 'scry', 'Transforms into a telescope, granting the user eagle-like long range vision. It is the sister Shen Gong Wu to the Falcon''s Eye.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (61, 'Seismokinesis', 'seize_ground', 'Grants the user seismic sense, and the power to open earthquakes or fissures at will - taking the ground itself.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (62, 'Anemokinesis', 'set_arena', 'Controls the weather, changing the arena''s element to the one the user calls.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (63, 'Chromakinesis', 'set_element', 'Shoots any random element from the center gem. Making Wu gain elemental powers. Also causes combustion.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (64, 'Hypersthenia', 'stat_shield', 'Grants the user super strength.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (65, 'Proaisthesis', 'stat_shield', 'It warned its user of impending danger.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (66, 'Gnoseokinesis', 'stat_shield', 'In form of a crown, grants the user infinite, but random knowledge. It can also grant perspective and sentience to an unintelligent beast. To gain specific knowledge use it with the Wushu Brcelet.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (67, 'Chi Reversal', 'stat_swap', 'When the Yo-Yo is broken into two parts, the user is still able to travel to the Yin-Yang World, but upon their return they will lose their predominant Chi and undergo a personality reversal.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (68, 'Temporokinesis', 'steal', 'Manipulates time, allowing for short-term time travel to multiple universes, or temporarily summoning another version of oneself from a different point in the infinite timelines.', 0, NULL, NULL);
...
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (75, 'Chi Exchange', 'transfer', 'Allows the user to control chi: for example astral project or swap two person''s souls entirly. If used on multiple people all have to be illuminated by its light.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (76, 'Chronomorphosis', 'treasure', 'Caused people to change age acording to the user (older/younger) rapidly. Can be used also to reverts a target back to its original form, such as turning oil into dinosaurs.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (77, 'Spirit Sealing', 'treasure', 'Traps spiritual bodies, such as Sibini or Wuya. There were multiple occurrences of this Wu.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (78, 'Fool''s Gold', 'treasure', 'Could produce laser beams of different colors, that could change everyone and everything color. Making people very enamoured by the object.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (79, 'Pyrophylaxia', 'ward', 'Covers the user in a shell of black bug that protects the user from extreme heat. It can also be used as a raft.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (80, 'Hydrophylaxia', 'ward', 'Allows the user to breathe underwater, transforming them into a fish-like being in the process (still can''t talk with fish).', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (81, 'Anemophylaxia', 'ward', 'Grants the user the physical characteristics, as well as the acrobatic agility and balance of a monkey. If it stays active for too long it slowly transforms the user into a monkey.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (82, 'Geophylaxia', 'ward', 'Transforms the user hands into one large drill, allowing him to travel underground and break even diamonds.', 0, NULL, NULL);
INSERT INTO power ("id", "name", "mechanic", "description", "initiative_bonus", "summon", "train_step") VALUES (83, 'Wish', 'wish', 'A mystical chest housing the spirit of a powerful yet blind swordsman in the guise of a genie; it grants a single wish to whoever holds it, and is spent forever in the granting.', 0, NULL, NULL);
...
INSERT INTO card ("id", "name", "force", "agility", "intellect", "power_id", "element", "type", "points") VALUES (5, 'Hodoku Mouse', 1, 1, 3, 1, 'metal', 'item', 5);
...
INSERT INTO card ("id", "name", "force", "agility", "intellect", "power_id", "element", "type", "points") VALUES (11, 'Kuzusu Atom', 2, 1, 2, 7, 'metal', 'item', 3);
...
INSERT INTO card ("id", "name", "force", "agility", "intellect", "power_id", "element", "type", "points") VALUES (13, 'Blade of the Nebula', -1, 2, 2, 9, 'wind', 'item', 3);
...
INSERT INTO card ("id", "name", "force", "agility", "intellect", "power_id", "element", "type", "points") VALUES (23, 'Jetbootsu', -1, 3, 0, 19, 'fire', 'boots', 2);
INSERT INTO card ("id", "name", "force", "agility", "intellect", "power_id", "element", "type", "points") VALUES (24, 'Mask of Rio', -1, 1, 3, 20, 'earth', 'head', 2);
...
INSERT INTO card ("id", "name", "force", "agility", "intellect", "power_id", "element", "type", "points") VALUES (34, 'Golden Tiger Claws', 2, 2, 1, 30, 'metal', 'arms', 3);
...
INSERT INTO card ("id", "name", "force", "agility", "intellect", "power_id", "element", "type", "points") VALUES (36, 'Woozy Shooter', -1, 0, -3, 32, 'metal', 'item', 3);
INSERT INTO card ("id", "name", "force", "agility", "intellect", "power_id", "element", "type", "points") VALUES (37, 'Shadow of Fear', -1, -1, -2, 33, 'metal', 'item', 3);
...
INSERT INTO card ("id", "name", "force", "agility", "intellect", "power_id", "element", "type", "points") VALUES (45, 'Vest of Komori', 0, -1, -3, 41, 'earth', 'torso', 3);
...
INSERT INTO card ("id", "name", "force", "agility", "intellect", "power_id", "element", "type", "points") VALUES (52, 'Rooster Booster', 2, 2, 3, 48, 'metal', 'item', 3);
...
INSERT INTO card ("id", "name", "force", "agility", "intellect", "power_id", "element", "type", "points") VALUES (73, 'Sands of Time', 2, -1, 2, 68, 'metal', 'item', 5);
...
INSERT INTO card ("id", "name", "force", "agility", "intellect", "power_id", "element", "type", "points") VALUES (77, 'Monarch Wings', -1, 2, 2, 72, 'metal', 'item', 4);
...
INSERT INTO card ("id", "name", "force", "agility", "intellect", "power_id", "element", "type", "points") VALUES (87, 'Tunnel Armadillo', 3, 1, 0, 82, 'earth', 'item', 2);
...
CREATE TABLE "mechanic_config" (
	...
	PRIMARY KEY("mechanic", "key")
);

INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('animate', 'field_stat', 2);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('animate', 'stat', 3);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('beast_form', 'boost', 1);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('beast_form', 'margin', 3);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('bot', 'attack_chance_when_leading', 2);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('bot', 'attack_chance_when_trailing', 5);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('bot', 'attack_max_chance', 90);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('bot', 'attack_min_chance', 5);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('bot', 'attack_momentum_cap', 30);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('bot', 'attack_momentum_step', 10);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('bot', 'attack_stat', 3);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('bot', 'chamelon_margin', 0);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('bot', 'flee_cap', 3);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('bot', 'good_jack_stat', 4);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('bot', 'jack_force_margin', 1);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('bot', 'printed_physical', 3);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('buff', 'value', 3);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('gamble', 'high', 5);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('gamble', 'low', -2);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('jong', 'boost_stat', 1);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('jong', 'stat', 6);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('morph', 'aside', 2);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('morph', 'boost', 1);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('scry', 'depth', 3);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('witchcraft', 'early_bird_gap', 2);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('witchcraft', 'recall_limit', 3);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('witchcraft', 'recall_margin', 3);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('witchcraft', 'returns', 1);
INSERT INTO mechanic_config ("mechanic", "key", "value") VALUES ('witchcraft', 'wears', 1);
