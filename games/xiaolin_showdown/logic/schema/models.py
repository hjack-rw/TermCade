...
class Player:
    ...
    # Mala Mala Jong (see logic/characters/jong.py): whether this duelist is wearing the construct, and the Heart
    ...
    # independently while the form is worn (see logic/flow/training.py); a gain here also raises the
